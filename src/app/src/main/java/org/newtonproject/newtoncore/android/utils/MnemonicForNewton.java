 ...
 */
public class MnemonicForNewton extends MnemonicUtils {


    private static final int SEED_ITERATIONS = 2048;
    private static final int SEED_KEY_SIZE = 512;
    private static List<String> WORD_LIST = null;
    private static String TAG = "MnemonicForNewton";
    /**
     ...
     * mnemonic sentence (in UTF-8 NFKD) used as the checkPassword and the string "mnemonic"
